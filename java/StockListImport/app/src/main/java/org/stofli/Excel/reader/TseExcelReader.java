package org.stofli.excel.reader;

import org.apache.poi.ss.usermodel.Cell;
import org.apache.poi.ss.usermodel.Row;
import org.stofli.excel.core.ExcelReader;
import org.stofli.excel.util.ExcelUtil;
...
public class TseExcelReader extends ExcelReader<TseData> {
  ...
  protected TseData mapRowToEntity(Row row) {
    ...
    return new TseData(
      ExcelUtil.readCell(date), 
      ExcelUtil.readCell(code), 
